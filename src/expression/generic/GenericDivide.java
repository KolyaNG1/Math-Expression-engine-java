...
public class GenericDivide<T> extends AbstrGenericBinaryOper<T> {
    ...
    public GenericDivide(GenericExpression<T> expr1, GenericExpression<T> expr2, GenericOperations<T> genericOperations) {
        super();
        this.expr1 = expr1;
        this.expr2 = expr2;
    ...
    public T calculate(T left, T right) {
        ...
        return genericOperations.divide(left, right);
    }
}
