...
public class GenericGreater<T> extends AbstrGenericBinaryOper<T> {
    ...
    public GenericGreater(GenericExpression<T> expr1, GenericExpression<T> expr2, GenericOperations<T> genericOperations) {
        super();
        this.expr1 = expr1;
        this.expr2 = expr2;
    ...
    public T calculate(T a, T b) {
        ...
        return genericOperations.greater(a, b);
    }
}