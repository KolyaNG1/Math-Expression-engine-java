...
public class GenericLessEq<T> extends AbstrGenericBinaryOper<T> {
    ...
    public GenericLessEq(GenericExpression<T> expr1, GenericExpression<T> expr2, GenericOperations<T> genericOperations) {
        super();
        this.expr1 = expr1;
        this.expr2 = expr2;
    ...
    public T calculate(T a, T b) {
        ...
        return genericOperations.lessEq(a, b);
    }
}
